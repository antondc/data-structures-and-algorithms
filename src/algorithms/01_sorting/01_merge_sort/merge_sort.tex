...
% section
\section{Description}
Recursive algorithm based on the divide and conquer strategy.\\
Based on two components: a function that splits the given list recursively until it receives a single item list, and a merge function that is used on the recursive algorithm to merge two already sorted lists into a combined sorted one.
