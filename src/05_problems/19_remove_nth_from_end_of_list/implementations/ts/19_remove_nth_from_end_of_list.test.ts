import { ListNode, removeNthFromEnd } from './19_remove_nth_from_end_of_list';


describe('Remove nth from end of list', () => {
  test('Returns correct result', () => {
    const node: ListNode = new ListNode(
      1,
      new ListNode(2, new ListNode(3, new ListNode(4, new ListNode(5, null)))),
    );
    const result = removeNthFromEnd(node, 2);
  ...
  test('Returns correct result', () => {
    ...
    const result = removeNthFromEnd(node, 1);
  ...
  test('Returns the correct result', () => {
    ...
    const result = removeNthFromEnd(node, 4);
    const expectedResult = {
      val: 20,
      next: {
        val: 30,
  ...
  test('Returns the correct result', () => {
    ...
    const result = removeNthFromEnd(node, 3); // remove "3"
    const expectedResult = {
      val: 1,
      next: {
        val: 2,
  ...
  test('Returns the correct result', () => {
    ...
    const result = removeNthFromEnd(node, 2); // remove the 3rd node (from start)
    const expectedResult = {
      val: 5,
      next: {
        val: 5,
  ...
  test('Returns the correct result', () => {
    ...
    const result = removeNthFromEnd(node, 5);
    const expectedResult = {
      val: 1,
      next: {
        val: 2,
  ...
  test('Returns the correct result', () => {
    // remove second node from end where multiple nodes share same value at edges
    const node: ListNode = new ListNode(
      1,
      new ListNode(1, new ListNode(1, new ListNode(2, new ListNode(1, null)))),
    );
    const result = removeNthFromEnd(node, 2); // remove the node with value 2
    const expectedResult = {
      val: 1,
      next: {
        val: 1,
